...
(function (t, n) {
  ...
  function r(t, n, e) {
    ...
    o = r / i;
    return o >= Ra ? i *= 10 : o >= La ? i *= 5 : o >= qa && (i *= 2),
    n < t ? - i : i
  }
  function i(t) {
    return t.length
  ...
  function u(t, n) {
    function e(e) {
      ...
      w = w.merge(T),
      N = N.merge(T.append('line').attr('stroke', '#000').attr(l + '2', f * a)),
      k = k.merge(T.append('text').attr('fill', '#000').attr(l, f * v).attr('dy', t === ja ? '0em' : t === Va ? '0.71em' : '0.32em')),
      e !== x && (b = b.transition(e), w = w.transition(e), N = N.transition(e), k = k.transition(e), M = M.transition(e).attr('opacity', Wa).attr('transform', function (t) {
      ...
      M.remove(),
      b.attr('d', t === $a || t == Xa ? 'M' + f * c + ',' + _ + 'H0.5V' + y + 'H' + f * c : 'M' + _ + ',' + f * c + 'V0.5H' + y + 'V' + f * c),
      w.attr('opacity', 1).attr('transform', function (t) {
        return h(m(t))
      }),
      N.attr(l + '2', f * a),
      k.attr(l, f * v).text(d),
      x.filter(o).attr('fill', 'none').attr('font-size', 10).attr('font-family', 'sans-serif').attr('text-anchor', t === Xa ? 'start' : t === $a ? 'end' : 'middle'),
      x.each(function () {
        this.__axis = m
      })
    }
    ...
    e.ticks = function () {
      return r = Ba.call(arguments),
      e
    },
    e.tickArguments = function (t) {
      return arguments.length ? (r = null == t ? [
      ] : Ba.call(t), e)  : r.slice()
    },
  ...
  function p(t, n, e) {
    ...
    return function (i, o, u) {
      ...
      c = this.__on,
      s = r(n, o, u);
      if (c) for (var f = 0, l = c.length; f < l; ++f) if ((a = c[f]).type === t.type && a.name === t.name) return this.removeEventListener(a.type, a.listener, a.capture),
  ...
  function Y(t) {
    return t instanceof U || (t = O(t)),
    t ? (t = t.rgb(), new H(t.r, t.g, t.b, t.opacity))  : new H
  }
  function B(t, n, e, r) {
  ...
  function X(t, n, e, r) {
    return 1 === arguments.length ? function (t) {
      ...
      a = o - i,
      c = (o + i) / 2;
      return a ? (u = n === o ? (e - r) / a + 6 * (e < r)  : e === o ? (r - n) / a + 2 : (n - e) / a + 4, a /= c < 0.5 ? o + i : 2 - o - i, u *= 60)  : a = c > 0 && c < 1 ? 0 : u,
      new V(u, a, c, t.opacity)
  ...
  function W(t) {
    ...
    r = tt(t.g),
    i = tt(t.b),
    o = Q((0.4124564 * e + 0.3575761 * r + 0.1804375 * i) / qc),
    u = Q((0.2126729 * e + 0.7151522 * r + 0.072175 * i) / Dc);
    return new G(116 * u - 16, 500 * (o - u), 200 * (u - Q((0.0193339 * e + 0.119192 * r + 0.9503041 * i) / Uc)), t.opacity)
  }
  function Z(t, n, e, r) {
  ...
  function xt() {
    gt(),
    ++Cs;
    for (var t, n = ts; n; ) (t = qs - n._time) >= 0 && n._call.call(null, t),
    n = n._next;
    --Cs
  }
  function bt() {
  ...
  function Ut(t, n) {
    for (var e; !(e = t.__transition) || !(e = e[n]); ) if (!(t = t.parentNode)) return Tf.time = gt(),
    Tf;
    return e
  }
  function Ot() {
  ...
  function jt(n) {
    function e(t) {
      ...
      t.selectAll('.selection').data([Ft('selection')]).enter().append('rect').attr('class', 'selection').attr('cursor', Df.selection).attr('fill', '#777').attr('fill-opacity', 0.3).attr('stroke', '#fff').attr('shape-rendering', 'crispEdges');
    ...
    function u() {
      function e() {
        var t = cc(w);
        !q || x || b || (Math.abs(t[0] - U[0]) > Math.abs(t[1] - U[1]) ? b = !0 : x = !0),
        U = t,
        m = !0,
        Ef(),
        o()
      ...
      function o() {
        ...
        switch (_ = U[0] - D[0], y = U[1] - D[1], T) {
          case Cf:
          case Af:
            N && (_ = Math.max(z - a, Math.min(R - p, _)), c = a + _, d = p + _),
            k && (y = Math.max(P - f, Math.min(L - v, y)), h = f + y, g = v + y);
            break;
          case zf:
            N < 0 ? (_ = Math.max(z - a, Math.min(R - a, _)), c = a + _, d = p)  : N > 0 && (_ = Math.max(z - p, Math.min(R - p, _)), c = a, d = p + _),
            k < 0 ? (y = Math.max(P - f, Math.min(L - f, y)), h = f + y, g = v)  : k > 0 && (y = Math.max(P - v, Math.min(L - v, y)), h = f, g = v + y);
            break;
          case Pf:
            N && (c = Math.max(z, Math.min(R, a - _ * N)), d = Math.max(z, Math.min(R, p + _ * N))),
            k && (h = Math.max(P, Math.min(L, f - y * k)), g = Math.max(P, Math.min(L, v + y * k)))
        }
        d < c && (N *= - 1, t = a, a = p, p = t, t = c, c = d, d = t, M in Uf && I.attr('cursor', Df[M = Uf[M]])),
        g < h && (k *= - 1, t = f, f = v, v = t, t = h, h = g, g = t, M in Of && I.attr('cursor', Df[M = Of[M]])),
        S.selection && (A = S.selection),
        x && (c = A[0][0], d = A[1][0]),
        b && (h = A[0][1], g = A[1][1]),
        A[0][0] === c && A[0][1] === h && A[1][0] === d && A[1][1] === g || (S.selection = [
          [c,
          h],
          [
            d,
      ...
      function u() {
        if (Ot(), t.event.touches) {
          ...
          F.on('touchmove.brush touchend.brush touchcancel.brush', null)
        } else C(t.event.view, m),
        Y.on('keydown.brush keyup.brush mousemove.brush mouseup.brush', null);
        F.attr('pointer-events', 'all'),
        I.attr('cursor', Df.overlay),
        S.selection && (A = S.selection),
        Ht(A) && (S.selection = null, r.call(w)),
        O.end()
      }
      if (t.event.touches) {
      ...
      if (l.apply(this, arguments)) {
        ...
        ] : (a = A[0][0], f = A[0][1], p = A[1][0], v = A[1][1]),
        c = a,
        h = f,
        d = p,
        g = v;
    ...
    function c() {
      ...
      return t.extent = f.apply(this, arguments),
      t.dim = n,
      t
    }
    var s,
    ...
    return e.move = function (t, e) {
      t.selection ? t.on('start.brush', function () {
        ...
        Gs(this),
        o.selection = null == u || Ht(u) ? null : u,
        r.call(this),
        a.start().brush().end()
      })
    },
    o.prototype = {
      ...
      emit: function (t) {
        d(new Sf(e, t, n.output(this.state.selection)), h.apply, h, [
          t,
          this.that,
          this.args
        ])
    ...
    e.extent = function (t) {
      return arguments.length ? (f = 'function' == typeof t ? t : kf([[ + t[0][0],
      + t[0][1]],
      [
        + t[1][0],
        + t[1][1]
  ...
  function xn(n) {
    return Sl = Cl(n),
    t.format = Sl.format,
    t.formatPrefix = Sl.formatPrefix,
    Sl
  }
  function bn() {
    this.reset()
  ...
  function Bn(t, n) {
    ...
    if ($l) {
      ...
      c = i[0] * yh * a,
      s = xh(u) > 180;
      s ^ (a * jl < c && c < a * t) ? (o = i[1] * yh) > Hl && (Hl = o)  : (c = (c + 360) % 360 - 180, s ^ (a * jl < c && c < a * t) ? (o = - i[1] * yh) < Yl && (Yl = o)  : (n < Yl && (Yl = n), n > Hl && (Hl = n))),
      s ? t < jl ? Wn(Il, t) > Wn(Il, Bl) && (Bl = t)  : Wn(t, Bl) > Wn(Il, Bl) && (Il = t)  : Bl >= Il ? (t < Il && (Il = t), t > Bl && (Bl = t))  : t > jl ? Wn(Il, t) > Wn(Il, Bl) && (Bl = t)  : Wn(t, Bl) > Wn(Il, Bl) && (Il = t)
    } else Wl.push(Zl = [
      Il = t,
      Bl = t
    ]);
  ...
  function he(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var s, f = i; r > 0 ? f > o : f < o; f -= c) s = Ln([u,
      - a * Mh(f),
      - a * Eh(f)]),
      t.point(s[0], s[1])
    }
  ...
  function ve(t) {
    if (n = t.length) {
      for (var n, e, r = 0, i = t[0]; ++r < n; ) i.n = e = t[r],
      e.p = i,
      i = e;
      i.n = e = t[0],
      e.p = i
    ...
    return function (u) {
      ...
      function s(o, u) {
        ...
        a && (b.lineStart(), b.point(o, u));
          ...
          var c = [
            g = Math.max(lp, Math.min(fp, g)),
            _ = Math.max(lp, Math.min(fp, _))
          ],
          s = [
            o = Math.max(lp, Math.min(fp, o)),
            u = Math.max(lp, Math.min(fp, u))
          ];
      ...
      M = {
        ...
        lineEnd: function () {
          f && (s(p, d), v && y && w.rejoin(), f.push(w.result())),
          M.point = c,
          y && b.lineEnd()
        },
        ...
        polygonEnd: function () {
          var n = function () {
            for (var n = 0, e = 0, i = l.length; e < i; ++e) for (var o, u, a = l[e], c = 1, s = a.length, f = a[0], h = f[0], p = f[1]; c < s; ++c) o = h,
            u = p,
            h = (f = a[c]) [0],
            p = f[1],
          ...
          e = x && n,
          i = (f = Fa(f)).length;
          (e || i) && (u.polygonStart(), e && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), i && rp(f, a, n, o, u), u.polygonEnd()),
          b = u,
          f = l = h = null
        }
      };
  ...
  function Ce() {
    ...
    t.stepMajor = function (n) {
      return arguments.length ? (g = + n[0], _ = + n[1], t)  : [
        g,
        _
      ]
    },
  ...
  function Qe(t, n, e) {
    ...
    return t.scale(150).translate([0,
    0]),
  ...
  function rr(t) {
    ...
    n.translate = function (t) {
      return arguments.length ? (g = + t[0], _ = + t[1], r())  : [
        g,
        _
      ]
    },
    n.center = function (t) {
      return arguments.length ? (y = t[0] % 360 * mh, m = t[1] % 360 * mh, r())  : [
        y * yh,
        m * yh
      ]
    },
    n.rotate = function (t) {
      return arguments.length ? (x = t[0] % 360 * mh, b = t[1] % 360 * mh, w = t.length > 2 ? t[2] % 360 * mh : 0, r())  : [
        x * yh,
        b * yh,
        w * yh
      ]
    ...
    function () {
      ...
      n.invert = o.invert && function (t) {
        return (t = s.invert((t[0] - u) / v, (a - t[1]) / v)) && [
          t[0] * yh,
          t[1] * yh
        ]
      },
  ...
  function ir(t) {
    ...
    return i.parallels = function (t) {
      return arguments.length ? r(n = t[0] * mh, e = t[1] * mh)  : [
        n * yh,
        e * yh
      ]
    },
  ...
  function or(t, n) {
    ...
    return e.invert = function (t, n) {
      var e = u - n;
      return [wh(t, xh(e)) / i * Ah(e),
      Tn((o - (t * t + e * e) * i * i) / (2 * i))]
    },
    e
  }
  function ur(t) {
  ...
  function gr(t, n) {
    var e = n * n,
    r = e * e;
    return [t * (0.8707 - 0.131979 * e + r * (r * (0.003971 * e - 0.001529 * r) - 0.013791)),
  ...
  function Tr(t, n) {
    ...
    for (null == n && (n = Nr); e = s.pop(); ) if (c && (e.value = + e.data.value), (i = n(e.data)) && (u = i.length)) for (e.children = new Array(u), o = u - 1; o >= 0; --o) s.push(r = e.children[o] = new Er(i[o])),
    r.parent = e,
    r.depth = e.depth + 1;
  ...
  function Cr(t, n) {
    var e = t.r - n.r + 0.000001,
    r = n.x - t.x,
    i = n.y - t.y;
    return e > 0 && e * e > r * r + i * i
  }
  function zr(t, n) {
    for (var e = 0; e < n.length; ++e) if (!Cr(t, n[e])) return !1;
    return !0
  }
  function Pr(t, n) {
    var e = t.x,
  ...
  function Or(t) {
    ...
    t: for (a = 3; a < i; ++a) {
      ...
      for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = Dr(n); (r = r.next) !== e; ) (u = Dr(r)) < o && (n = r, o = u);
      e = n.next
    }
    for (n = [
      e._
    ], r = e; (r = r.next) !== e; ) n.push(r._);
    for (r = nd(n), a = 0; a < i; ++a) n = t[a],
    n.x -= r.x,
    n.y -= r.y;
    return r.r
  }
  ...
  function Hr(t, n) {
    return function (e) {
      if (r = e.children) {
        ...
        if (o = Or(r), a) for (i = 0; i < u; ++i) r[i].r -= a;
        e.r = o + a
      }
    }
  }
  ...
  function Kr(t, n, e, r, i, o) {
    for (var u, a, c, s, f, l, h, p, d, v, g, _ = [
    ], y = n.children, m = 0, x = 0, b = y.length, w = n.value; m < b; ) {
      c = i - e,
      s = o - r;
      do {
        f = y[x++].value
      ...
      u.dice ? id(u, e, r, i, w ? r += s * f / w : o)  : cd(u, e, r, w ? e += c * f / w : i, o),
      w -= f,
      m = x
    }
    return _
  ...
  function pi(t) {
    ...
    t.nice = function (r) {
      ...
      c = o[u],
      s = o[a];
      return s < c && (i = c, c = s, s = i, i = u, u = a, a = i),
      (i = e(c, s, r)) > 0 ? i = e(c = Math.floor(c / i) * i, s = Math.ceil(s / i) * i, r)  : i < 0 && (i = e(c = Math.ceil(c * i) / i, s = Math.floor(s * i) / i, r)),
      i > 0 ? (o[u] = Math.floor(c / i) * i, o[a] = Math.ceil(s / i) * i, n(o))  : i < 0 && (o[u] = Math.ceil(c * i) / i, o[a] = Math.floor(s * i) / i, n(o)),
      t
    },
    t
  }
    ...
    function e(t, n) {
      return function (e) {
        ...
        if ('p' in u && (u.H = u.H % 12 + 12 * u.p), 'V' in u) {
          ...
          'w' in u || (u.w = 1),
          'Z' in u ? (i = (o = (i = zi(Pi(u.y))).getUTCDay()) > 4 || 0 === o ? Nv.ceil(i)  : Nv(i), i = wv.offset(i, 7 * (u.V - 1)), u.y = i.getUTCFullYear(), u.m = i.getUTCMonth(), u.d = i.getUTCDate() + (u.w + 6) % 7)  : (i = (o = (i = n(Pi(u.y))).getDay()) > 4 || 0 === o ? nv.ceil(i)  : nv(i), i = Jd.offset(i, 7 * (u.V - 1)), u.y = i.getFullYear(), u.m = i.getMonth(), u.d = i.getDate() + (u.w + 6) % 7)
  ...
  function Ui(t) {
    for (var n = {
    }, e = - 1, r = t.length; ++e < r; ) n[t[e].toLowerCase()] = e;
    return n
  }
  function Oi(t, n, e) {
  ...
  function ji(t, n, e) {
    var r = jv.exec(n.slice(e, e + 2));
    return r ? (t.y = + r[0] + ( + r[0] > 68 ? 1900 : 2000), e + r[0].length)  : - 1
  }
  function Xi(t, n, e) {
  ...
  function Ki(t, n, e) {
    ...
    return r ? (t.L = Math.floor(r[0] / 1000), e + r[0].length)  : - 1
  }
  function to(t, n, e) {
  ...
  function eo(t, n, e) {
    var r = jv.exec(n.slice(e));
    return r ? (t.Q = 1000 * + r[0], e + r[0].length)  : - 1
  }
  function ro(t, n) {
  ...
  function vo(t, n) {
    ...
    Li(iv.count(gv(t), t) + (4 === gv(t).getDay()), n, 2)
  }
  function go(t) {
    return t.getDay()
  }
  ...
  function mo(t, n) {
    return Li(t.getFullYear() % 10000, n, 4)
  }
  function xo(t) {
  ...
  function Po(t, n) {
    var e = t.getUTCDay();
    return t = e >= 4 || 0 === e ? Ev(t)  : Ev.ceil(t),
    Li(Ev.count(Iv(t), t) + (4 === Iv(t).getUTCDay()), n, 2)
  }
  function Ro(t) {
    return t.getUTCDay()
  }
  ...
  function Do(t, n) {
    return Li(t.getUTCFullYear() % 10000, n, 4)
  }
  function Uo() {
    return '+0000'
  }
  ...
  function Yo(n) {
    return Yv = Ri(n),
    t.timeFormat = Yv.format,
    t.timeParse = Yv.parse,
    t.utcFormat = Yv.utcFormat,
    t.utcParse = Yv.utcParse,
    Yv
  }
  function Bo(t) {
    return new Date(t)
  ...
  function cu(t) {
    function n() {
      ...
      c = e.apply(this, a),
      s = r.apply(this, a);
      if (u || (u = n = Vt()), t(u, + i.apply(this, (a[0] = c, a)), + o.apply(this, a), + i.apply(this, (a[0] = s, a)), + o.apply(this, a)), n) return u = null,
      n + '' || null
    }
    var e = uu,
    r = au,
  ...
  function Su(t, n, e) {
    ...
    u = (e - t._y1) / (i || r < 0 && - 0),
    a = (o * i + u * r) / (r + i);
    return (ku(o) + ku(u)) * Math.min(Math.abs(o), Math.abs(u), 0.5 * Math.abs(a)) || 0
  }
  function Eu(t, n) {
    var e = t._x1 - t._x0;
  ...
  function Xu(t, n, e, r) {
    ...
    e && $u(i, t, n, e),
    r && $u(i, n, t, r),
    v_[t.index].halfedges.push(o),
    v_[n.index].halfedges.push(o),
    i
  }
  function Vu(t, n, e) {
    var r = [
    ...
    if (n && e) {
      ...
      if (r !== o) {
        ...
        if (!(h >= - b_)) {
          ...
          t.circle = _;
          for (var y = null, m = g_._; m; ) if (_.y < m.y || _.y === m.y && _.x <= m.x) {
            if (!m.L) {
              y = m.P;
              break
            }
  ...
  function ra(t) {
    ...
    ea(t);
    for (var c = o; c.circle && Math.abs(e - c.circle.x) < x_ && Math.abs(r - c.circle.cy) < x_; ) o = c.P,
    a.unshift(c),
    ea(c),
    c = o;
    a.unshift(c),
    ta(c);
    for (var s = u; s.circle && Math.abs(e - s.circle.x) < x_ && Math.abs(r - s.circle.cy) < x_; ) u = s.N,
    a.push(s),
    ea(s),
    s = u;
    a.push(s),
    ...
    for (f = 1; f < l; ++f) s = a[f],
    c = a[f - 1],
    $u(s.edge, c.site, s.site, i);
    c = a[0],
    (s = a[l - 1]).edge = Xu(c.site, s.site, null, i),
    Ku(c),
    Ku(s)
  }
  function ia(t) {
    for (var n, e, r, i, o = t[0], u = t[1], a = d_._; a; ) if ((r = oa(a, u) - o) > x_) a = a.L;
     else {
      if (!((i = o - function (t, n) {
        var e = t.N;
        if (e) return oa(e, n);
    ...
    if (d_.insert(n, c), n || e) {
      ...
      if (e) {
        ...
        $u(e.edge, s, d, x),
        c.edge = Xu(s, t, null, x),
        e.edge = Xu(t, d, null, x),
        Ku(n),
        Ku(e)
  ...
  function ca(t, n) {
    ...
    o = t.sort(aa).pop();
    for (__ = [
    ], v_ = new Array(t.length), d_ = new Iu, g_ = new Iu; ; ) if (i = p_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (ia(o), e = o[0], r = o[1]),
    o = t.pop();
     else {
      if (!i) break;
      ra(i.arc)
    ...
    if (function () {
      for (var t, n, e, r, i = 0, o = v_.length; i < o; ++i) if ((t = v_[i]) && (r = (n = t.halfedges).length)) {
        var u = new Array(r),
        a = new Array(r);
        for (e = 0; e < r; ++e) u[e] = e,
        a[e] = Gu(t, __[n[e]]);
      ...
      function (t, n, e, r) {
        ...
        g = v_.length,
        _ = !0;
        for (i = 0; i < g; ++i) if (o = v_[i]) {
          for (u = o.site, a = (c = o.halfedges).length; a--; ) __[c[a]] || c.splice(a, 1);
          for (a = 0, s = c.length; a < s; ) d = (p = Ju(o, __[c[a]])) [0],
          v = p[1],
          l = (f = Qu(o, __[c[++a % s]])) [0],
          h = f[1],
          (Math.abs(d - l) > x_ || Math.abs(v - h) > x_) && (c.splice(a, 0, __.push(Vu(u, p, Math.abs(d - t) < x_ && r - v > x_ ? [
            t,
            Math.abs(l - t) < x_ ? h : r
          ] : Math.abs(v - r) < x_ && e - d > x_ ? [
            Math.abs(h - r) < x_ ? l : e,
            r
          ] : Math.abs(d - e) < x_ && v - n > x_ ? [
            e,
            Math.abs(l - e) < x_ ? h : n
          ] : Math.abs(v - n) < x_ && d - t > x_ ? [
            Math.abs(h - n) < x_ ? l : t,
            n
          ] : null)) - 1), ++s);
          s && (_ = !1)
  ...
  Ta = function (t, n) {
    ...
    a = 0,
    c = 0;
    if (null == n) for (; ++u < i; ) isNaN(e = Ma(t[u])) || (c += (r = e - a) * (e - (a += r / ++o)));
     else for (; ++u < i; ) isNaN(e = Ma(n(t[u], u, t))) || (c += (r = e - a) * (e - (a += r / ++o)));
    if (o > 1) return c / (o - 1)
  },
  Na = function (t, n) {
    var e = Ta(t, n);
  ...
  Da = function (t, n, r) {
    ...
    if (a > 0) for (t = Math.ceil(t / a), n = Math.floor(n / a), u = new Array(o = Math.ceil(n - t + 1)); ++c < o; ) u[c] = (t + c) * a;
     else for (t = Math.floor(t * a), n = Math.ceil(n * a), u = new Array(o = Math.ceil(t - n + 1)); ++c < o; ) u[c] = (t - c) / a;
    return i && u.reverse(),
    u
  },
  Ua = function (t) {
  ...
  Ya = function (t) {
    ...
    for (var n = - 1, e = Ia(t, i), r = new Array(e); ++n < e; ) for (var o, u = - 1, a = r[n] = new Array(o); ++u < o; ) a[u] = t[u][n];
    return r
  },
  ...
  ac = function (t, n) {
    ...
    return [n.clientX - i.left - t.clientLeft,
  ...
  S.prototype = E.prototype = {
    ...
    selectAll: function (t) {
      ...
      for (var n = this._groups, e = n.length, r = [
      ], i = [
      ], o = 0; o < e; ++o) for (var u, a = n[o], c = a.length, s = 0; s < c; ++s) (u = a[s]) && (r.push(t.call(u, u.__data__, s, a)), i.push(u));
      return new S(r, i)
    },
    filter: function (t) {
      'function' != typeof t && (t = ic(t));
      for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i) for (var o, u = n[i], a = u.length, c = r[i] = [
    ...
    data: function (t, n) {
      ...
      for (var o = i.length, u = new Array(o), a = new Array(o), c = new Array(o), s = 0; s < o; ++s) {
        ...
        for (var y, m, x = 0, b = 0; x < d; ++x) if (y = g[x]) {
    ...
    classed: function (t, n) {
      var e = y(t + '');
      if (arguments.length < 2) {
        for (var r = m(this.node()), i = - 1, o = e.length; ++i < o; ) if (!r.contains(e[i])) return !1;
        return !0
      }
  ...
  var vc = function (t) {
    return 'string' == typeof t ? new S([[document.querySelector(t)]], [
      document.documentElement
    ])  : new S([[t]], dc)
  },
  gc = function (t, n, e) {
    arguments.length < 3 && (e = n, n = uc().changedTouches);
    for (var r, i = 0, o = n ? n.length : 0; i < o; ++i) if ((r = n[i]).identifier === e) return ac(t, r);
    return null
  },
  _c = function () {
  ...
  Tc = /^#([0-9a-f]{3})$/,
  Nc = /^#([0-9a-f]{6})$/,
  kc = new RegExp('^rgb\\(' + [bc,
  bc,
  bc] + '\\)$'),
  Sc = new RegExp('^rgb\\(' + [Mc,
  Mc,
  Mc] + '\\)$'),
  Ec = new RegExp('^rgba\\(' + [bc,
  bc,
  bc,
  wc] + '\\)$'),
  Ac = new RegExp('^rgba\\(' + [Mc,
  Mc,
  Mc,
  wc] + '\\)$'),
  Cc = new RegExp('^hsl\\(' + [wc,
  Mc,
  Mc] + '\\)$'),
  zc = new RegExp('^hsla\\(' + [wc,
  Mc,
  Mc,
  wc] + '\\)$'),
  Pc = {
  ...
  xc(H, B, D(U, {
    brighter: function (t) {
      return t = null == t ? 1 / 0.7 : Math.pow(1 / 0.7, t),
      new H(this.r * t, this.g * t, this.b * t, this.opacity)
    },
    darker: function (t) {
      return t = null == t ? 0.7 : Math.pow(0.7, t),
      new H(this.r * t, this.g * t, this.b * t, this.opacity)
    },
    rgb: function () {
      return this
  ...
  xc(G, Z, D(U, {
    ...
    rgb: function () {
      ...
      n = qc * J(n),
      e = Uc * J(e),
      new H(K(3.2404542 * n - 1.5371385 * t - 0.4985314 * e), K( - 0.969266 * n + 1.8760108 * t + 0.041556 * e), K(0.0556434 * n - 0.2040259 * t + 1.0572252 * e), this.opacity)
    }
  })),
  xc(et, nt, D(U, {
    brighter: function (t) {
  ...
  ds = function (t, n) {
    ...
    for (t += '', n += ''; (e = hs.exec(t)) && (r = ps.exec(n)); ) (i = r.index) > o && (i = n.slice(o, i), a[u] ? a[u] += i : a[++u] = i),
  ...
  yt.prototype = mt.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      e = (null == e ? gt()  : + e) + (null == n ? 0 : + n),
      this._next || ns === this || (ns ? ns._next = this : ts = this, ns = this),
      this._call = t,
      this._time = e,
      Mt()
    },
  ...
  Et.prototype = At.prototype = {
    ...
    select: function (t) {
      ...
      e = this._id;
      'function' != typeof t && (t = sc(t));
      for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u) for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h) (a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ('__data__' in a && (c.__data__ = a.__data__), l[h] = c, Zs(l[h], n, e, h, l, kt(a, e)));
    ...
    selectAll: function (t) {
      ...
      e = this._id;
      'function' != typeof t && (t = fc(t));
      for (var r = this._groups, i = r.length, o = [
      ], u = [
      ], a = 0; a < i; ++a) for (var c, s = r[a], f = s.length, l = 0; l < f; ++l) if (c = s[l]) {
    ...
    transition: function () {
      for (var t = this._name, n = this._id, e = Ct(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) if (u = a[s]) {
        var f = kt(u, n);
        Zs(u, t, e, s, a, {
    ...
    style: function (t, n, e) {
      ...
      return null == n ? this.styleTween(t, function (t, n) {
        ...
        return function () {
          var u = _(this, t),
          a = e(this);
          return null == a && (this.style.removeProperty(t), a = _(this, t)),
    ...
    tween: function (t, n) {
      ...
      if (t += '', arguments.length < 2) {
        for (var r, i = kt(this.node(), e).tween, o = 0, u = i.length; o < u; ++o) if ((r = i[o]).name === t) return r.value;
        return null
      }
  ...
  E.prototype.transition = function (t) {
    ...
    for (var r = this._groups, i = r.length, o = 0; o < i; ++o) for (var u, a = r[o], c = a.length, s = 0; s < c; ++s) (u = a[s]) && Zs(u, t, n, s, a, e || Ut(u, n));
  ...
  Xt.prototype = Vt.prototype = {
    ...
    arcTo: function (t, n, e, r, i) {
      ...
      if (null === this._x1) this._ += 'M' + (this._x1 = t) + ',' + (this._y1 = n);
       else if (l > 0.000001) if (Math.abs(f * a - c * s) > 0.000001 && i) {
        var h = e - o,
        p = r - u,
        d = a * a + c * c,
        v = h * h + p * p,
        ...
        m = y / _,
        x = y / g;
        Math.abs(m - 1) > 0.000001 && (this._ += 'L' + (t + m * s) + ',' + (n + m * f)),
    ...
    arc: function (t, n, e, r, i, o) {
      ...
      null === this._x1 ? this._ += 'M' + c + ',' + s : (Math.abs(this._x1 - c) > 0.000001 || Math.abs(this._y1 - s) > 0.000001) && (this._ += 'L' + c + ',' + s),
      e && (l < 0 && (l = l % Gf + Gf), l > Qf ? this._ += 'A' + e + ',' + e + ',0,1,' + f + ',' + (t - u) + ',' + (n - a) + 'A' + e + ',' + e + ',0,1,' + f + ',' + (this._x1 = c) + ',' + (this._y1 = s)  : l > 0.000001 && (this._ += 'A' + e + ',' + e + ',0,' + + (l >= Zf) + ',' + f + ',' + (this._x1 = t + e * Math.cos(i)) + ',' + (this._y1 = n + e * Math.sin(i))))
    },
    ...
    function n(t, n) {
      function e() {
        ...
        if (t.charCodeAt(r) === nl) {
          ...
          return (n = a) >= u ? s = !0 : (e = t.charCodeAt(a++)) === el ? f = !0 : e === rl && (f = !0, t.charCodeAt(a) === el && ++a),
      ...
      s = u <= 0,
      f = !1;
      for (t.charCodeAt(u - 1) === el && --u, t.charCodeAt(u - 1) === rl && --u; (r = e()) !== tl; ) {
        for (var l = [
        ]; r !== Kf && r !== tl; ) l.push(r),
        r = e();
  ...
  gl = function () {
    return 0.000001 * (Math.random() - 0.5)
  },
  ...
  yl.copy = function () {
    ...
    r = this._root;
    if (!r) return e;
    if (!r.length) return e._root = ln(r),
    e;
    for (t = [
      {
        source: r,
  ...
  yl.find = function (t, n, e) {
    ...
    v = this._root;
    for (v && d.push(new _l(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop(); ) if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l)) if (v.length) {
      var g = (i + u) / 2,
      _ = (o + a) / 2;
      d.push(new _l(v[3], g, _, u, a), new _l(v[2], i, _, g, a), new _l(v[1], g, o, u, _), new _l(v[0], i, o, g, _)),
  ...
  yl.visit = function (t) {
    ...
    c = this._root;
    for (c && a.push(new _l(c, this._x0, this._y0, this._x1, this._y1)); n = a.pop(); ) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, u = n.y1) && c.length) {
      var s = (r + o) / 2,
      f = (i + u) / 2;
      (e = c[3]) && a.push(new _l(e, s, f, o, u)),
      (e = c[2]) && a.push(new _l(e, r, f, s, u)),
      (e = c[1]) && a.push(new _l(e, s, i, o, f)),
      (e = c[0]) && a.push(new _l(e, r, i, s, f))
    }
    return this
  },
  yl.visitAfter = function (t) {
    ...
    for (this._root && e.push(new _l(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop(); ) {
      ...
      if (i.length) {
        ...
        f = (u + c) / 2,
        l = (a + s) / 2;
        (o = i[0]) && e.push(new _l(o, u, a, f, l)),
        (o = i[1]) && e.push(new _l(o, f, a, c, l)),
        (o = i[2]) && e.push(new _l(o, u, l, f, s)),
        (o = i[3]) && e.push(new _l(o, f, l, c, s))
      }
      r.push(n)
    }
  ...
  wl = function (t, n) {
    ...
    var e,
    r = t.slice(0, e);
    return [r.length > 1 ? r[0] + r.slice(2)  : r,
    + t.slice(e + 1)]
  },
  Ml = function (t) {
  ...
  Cl = function (t) {
    function n(t) {
      function n(t) {
        ...
        t = '';
          ...
          var b = (t = + t) < 0;
          if (t = y(Math.abs(t), d), b && 0 == + t && (b = !1), f = (b ? '(' === s ? s : '-' : '-' === s || '(' === s ? '' : s) + f, x = x + ('s' === v ? Al[8 + ml / 3] : '') + (b && '(' === s ? ')' : ''), m) for (n = - 1, r = t.length; ++n < r; ) if (48 > (u = t.charCodeAt(n)) || u > 57) {
    ...
    var e = t.grouping && t.thousands ? function (t, n) {
      return function (e, r) {
        ...
        ], u = 0, a = t[0], c = 0; i > 0 && a > 0 && (c + a + 1 > r && (a = Math.max(1, r - c)), o.push(e.substring(i -= a, i + a)), !((c += a + 1) > r)); ) a = t[u = (u + 1) % t.length];
  ...
  bn.prototype = {
    ...
    add: function (t) {
      wn(hh, t, this.t),
      wn(this, hh.s, this.s),
      this.s ? this.t += hh.t : this.s = hh.t
    },
    valueOf: function () {
      return this.s
    }
  ...
  Rh = {
    ...
    MultiPoint: function (t, n) {
      for (var e = t.coordinates, r = - 1, i = e.length; ++r < i; ) t = e[r],
      n.point(t[0], t[1], t[2])
    },
  ...
  Fh = {
    ...
    polygonEnd: function () {
      ...
      Fh.lineStart = Hn,
      Fh.lineEnd = jn,
      qh < 0 ? (Il = - (Bl = 180), Yl = - (Hl = 90))  : Oh > ph ? Hl = 90 : Oh < - ph && (Yl = - 90),
      Zl[0] = Il,
      Zl[1] = Bl
    }
  },
  ...
  tp = function (t) {
    function n(n) {
      return n = t(n[0] * mh, n[1] * mh),
      n[0] *= yh,
      n[1] *= yh,
      n
    }
    return t = ce(t[0] * mh, t[1] * mh, t.length > 2 ? t[2] * mh : 0),
    n.invert = function (n) {
      return n = t.invert(n[0] * mh, n[1] * mh),
      n[0] *= yh,
      n[1] *= yh,
      n
    },
    ...
    if (t.forEach(function (t) {
      if (!((n = t.length - 1) <= 0)) {
        ...
        if (ep(r, u)) {
          ...
          i.lineEnd()
        } else a.push(e = new de(r, t, null, !0)),
        c.push(e.o = new de(r, null, e, !1)),
        a.push(e = new de(u, t, null, !1)),
        c.push(e.o = new de(u, null, e, !0))
      }
    }), a.length) {
  ...
  op = function (t, n) {
    ...
    u = 0;
    ip.reset();
    for (var a = 0, c = t.length; a < c; ++a) if (f = (s = t[a]).length) for (var s, f, l = s[f - 1], h = l[0], p = l[1] / 2 + gh, d = Eh(p), v = Mh(p), g = 0; g < f; ++g, h = y, d = x, v = b, l = _) {
      var _ = s[g],
      y = _[0],
      m = _[1] / 2 + gh,
      x = Eh(m),
    ...
    return function (i) {
      ...
      m = {
        ...
        polygonEnd: function () {
          ...
          p = Fa(p);
          var t = op(h, r);
          p.length ? (y || (i.polygonStart(), y = !0), rp(p, _e, t, e, i))  : t && (y || (i.polygonStart(), y = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
          y && (i.polygonEnd(), y = !1),
          p = h = null
        },
        sphere: function () {
    ...
    return up(n, function (t) {
      ...
      return {
        ...
        point: function (l, h) {
          ...
          if (!i && (s = c = v) && t.lineStart(), v !== c && (!(p = e(i, d)) || ep(i, p) || ep(d, p)) && (d[0] += ph, d[1] += ph, v = n(d[0], d[1])), v !== c) f = 0,
  ...
  yp = {
    ...
    FeatureCollection: function (t, n) {
      for (var e = t.features, r = - 1, i = e.length; ++r < i; ) if (we(e[r].geometry, n)) return !0;
      return !1
    }
  },
  mp = {
    ...
    MultiPoint: function (t, n) {
      for (var e = t.coordinates, r = - 1, i = e.length; ++r < i; ) if (Me(e[r], n)) return !0;
      return !1
    },
    LineString: function (t, n) {
    ...
    MultiLineString: function (t, n) {
      for (var e = t.coordinates, r = - 1, i = e.length; ++r < i; ) if (Te(e[r], n)) return !0;
      return !1
    },
    Polygon: function (t, n) {
    ...
    MultiPolygon: function (t, n) {
      for (var e = t.coordinates, r = - 1, i = e.length; ++r < i; ) if (Ne(e[r], n)) return !0;
      return !1
    },
    GeometryCollection: function (t, n) {
      for (var e = t.geometries, r = - 1, i = e.length; ++r < i; ) if (we(e[r], n)) return !0;
      return !1
    }
  },
  xp = function (t) {
  ...
  Mp = {
    ...
    polygonEnd: function () {
      Mp.lineStart = Mp.lineEnd = Mp.point = kn,
      bp.add(xh(wp)),
      wp.reset()
    },
    result: function () {
  ...
  Op = {
    ...
    result: function () {
      ...
      return Ap = Cp = zp = Pp = Rp = Lp = qp = Dp = Up = 0,
      t
    }
  };
  je.prototype = {
    ...
    point: function (t, n) {
      switch (this._point) {
        ...
        default:
          ...
          this._context.arc(t, n, this._radius, 0, _h)
      }
    },
    result: kn
  };
    ...
    point: function (t, n) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        default:
          null == this._circle && (this._circle = We(this._radius)),
    ...
    return + n ? function (t, n) {
      function e(r, i, o, u, a, c, s, f, l, h, p, d, v, g) {
        ...
        if (m > 4 * n && v--) {
          ...
          C = E - i,
          z = y * A - _ * C;
          (z * z / m > n || xh((_ * A + y * C) / m - 0.5) > 0.3 || u * h + a * p + c * d < $p) && (e(r, i, o, u, a, c, S, E, N, x /= M, b /= M, w, v, g), g.point(S, E), e(S, E, N, x, b, w, s, f, l, h, p, d, v, g))
        }
      }
      return function (n) {
        function r(e, r) {
        ...
        function o(r, i) {
          ...
          i]),
          u = t(r, i);
          e(_, y, g, m, x, b, _ = u[0], y = u[1], g = r, m = o[0], x = o[1], b = o[2], Vp, n),
          n.point(_, y)
        }
        function u() {
          w.point = r,
        ...
        function s() {
          e(_, y, g, m, x, b, l, h, f, p, d, v, Vp, n),
          w.lineEnd = u,
          u()
        }
        var f,
  ...
  Gp = function () {
    return ir(or).scale(155.424).center([0,
    33.6442])
  },
  Qp = function () {
    return Gp().parallels([29.5,
  ...
  gr.invert = function (t, n) {
    ...
    do {
      var o = r * r,
      u = o * o;
      r -= e = (r * (1.007226 + o * (0.015085 + u * (0.028874 * o - 0.044475 - 0.005916 * u))) - n) / (1.007226 + o * (0.045255 + u * (0.259866 * o - 0.311325 - 0.005916 * 11 * u)))
    } while (xh(e) > ph && --i > 0);
    return [t / (0.8707 + (o = r * r) * (o * (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) - 0.131979)),
    r]
  };
  _r.invert = ar(Tn);
  ...
  Er.prototype = Tr.prototype = {
    ...
    each: function (t) {
      ...
      do {
        for (n = u.reverse(), u = [
        ]; o = n.pop(); ) if (t(o), e = o.children) for (r = 0, i = e.length; r < i; ++r) u.push(e[r])
      } while (u.length);
      return this
    },
    eachAfter: function (t) {
      ...
      ]; i = o.pop(); ) if (u.push(i), n = i.children) for (e = 0, r = n.length; e < r; ++e) o.push(n[e]);
      for (; i = u.pop(); ) t(i);
      return this
    },
  ...
  nd = function (t) {
    ...
    e && Cr(e, n) ? ++r : (e = function (t) {
      ...
      r;
      if (zr(n, t)) return [n];
      for (e = 0; e < t.length; ++e) if (Ar(n, t[e]) && zr(Pr(t[e], n), t)) return [t[e],
      n];
      for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (Ar(Pr(t[e], t[r]), n) && Ar(Pr(t[e], n), t[r]) && Ar(Pr(t[r], n), t[e]) && zr(Rr(t[e], t[r], n), t)) return [t[e],
      t[r],
      n];
      throw new Error
    }(o, n)),
  ...
  id = function (t, n, e, r, i) {
    for (var o, u = t.children, a = - 1, c = u.length, s = t.value && (r - n) / t.value; ++a < c; ) (o = u[a]).y0 = e,
    o.y1 = i,
    o.x0 = n,
    o.x1 = n += o.value * s
  },
  ...
  var cd = function (t, n, e, r, i) {
    for (var o, u = t.children, a = - 1, c = u.length, s = t.value && (i - e) / t.value; ++a < c; ) (o = u[a]).x0 = n,
    o.x1 = r,
    o.y0 = e,
    o.y1 = e += o.value * s
  },
  ...
  ld = function t(n) {
    function e(t, e, r, i, o) {
      if ((u = t._squarify) && u.ratio === n) for (var u, a, c, s, f, l = - 1, h = u.length, p = t.value; ++l < h; ) {
        ...
        a.dice ? id(a, e, r, i, r += (o - r) * a.value / p)  : cd(a, e, r, e += (i - e) * a.value / p, o),
        p -= a.value
      } else t._squarify = u = Kr(n, t, e, r, i, o),
      u.ratio = n
    }
    return e.ratio = function (n) {
      return t((n = + n) > 1 ? n : 1)
  ...
  ei.prototype = ui.prototype = {
    ...
    abort: function () {
      return null == this._error && ii(this, new Error('abort')),
      this
    },
    await: function (t) {
      if ('function' != typeof t) throw new Error('invalid callback');
  ...
  wd = function (t, n) {
    ...
    if ('undefined' == typeof XDomainRequest || 'withCredentials' in f || !/^(http(s)?:)?\/\//.test(t) || (f = new XDomainRequest), 'onload' in f ? f.onload = f.onerror = f.ontimeout = e : f.onreadystatechange = function (t) {
      ...
      header: function (t, n) {
        ...
        arguments.length < 2 ? s.get(t)  : (null == n ? s.remove(t)  : s.set(t, n + ''), r)
      },
      mimeType: function (t) {
  ...
  Od = function (n, e, i) {
    ...
    switch ((i = yn(null == i ? ',f' : i)).type) {
      case 's':
        ...
        return null != i.precision || isNaN(o = Pl(c, s)) || (i.precision = o),
        t.formatPrefix(i, s);
      case '':
      case 'e':
      case 'g':
  ...
  Bd.every = function (t) {
    return t = Math.floor(t),
    isFinite(t) && t > 0 ? t > 1 ? Si(function (n) {
  ...
  Xd = 604800000,
  Vd = Si(function (t) {
    t.setTime(1000 * Math.floor(t / 1000))
  }, function (t, n) {
    t.setTime( + t + 1000 * n)
  }, function (t, n) {
    return (n - t) / 1000
  ...
  Zd = Wd.range,
  Gd = Si(function (t) {
    var n = t.getTimezoneOffset() * jd % 3600000;
    n < 0 && (n += 3600000),
    t.setTime(3600000 * Math.floor(( + t - n) / 3600000) + n)
  }, function (t, n) {
    t.setTime( + t + 3600000 * n)
  }, function (t, n) {
    return (n - t) / 3600000
  }, function (t) {
    return t.getHours()
  ...
  Jd = Si(function (t) {
    ...
    return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * jd) / 86400000
  }, function (t) {
    return t.getDate() - 1
  }),
  Kd = Jd.range,
  ...
  ag = As(rt(300, 0.5, 0), rt( - 240, 0.5, 1)),
  cg = As(rt( - 100, 0.75, 0.35), rt(80, 1.5, 0.8)),
  sg = As(rt(260, 0.75, 0.35), rt(80, 1.5, 0.8)),
  fg = rt(),
  ...
  Eg = function () {
    function t(t) {
      ...
      f = t.length,
      l = !1;
      for (null == i && (u = o(s = Vt())), a = 0; a <= f; ++a) !(a < f && r(c = t[a], a, t)) === l && ((l = !l) ? u.lineStart()  : u.lineEnd()),
  ...
  qg = function (t, n) {
    return [(n = + n) * Math.cos(t -= Math.PI / 2),
    n * Math.sin(t)]
  },
  ...
  Kg = {
    draw: function (t, n) {
      ...
      t.lineTo(o, u),
      t.lineTo(a, c),
      t.lineTo(Zg * r - Gg * i, Gg * r + Zg * i),
      t.lineTo(Zg * o - Gg * u, Gg * o + Zg * u),
      t.lineTo(Zg * a - Gg * c, Gg * a + Zg * c),
      t.lineTo(Zg * r + Gg * i, Zg * i - Gg * r),
      t.lineTo(Zg * o + Gg * u, Zg * u - Gg * o),
      t.lineTo(Zg * a + Gg * c, Zg * c - Gg * a),
      t.closePath()
    }
  },
  t_ = [
    ...
    point: function (t, n) {
      ...
      if (t = + t, n = + n, t !== this._x1 || n !== this._y1) {
        switch (this._point) {
          ...
          case 2:
            this._point = 3,
            Au(this, Eu(this, e = Su(this, t, n)), e);
            break;
          default:
  ...
  Ru.prototype = {
    ...
    lineEnd: function () {
      ...
      if (e) if (this._line ? this._context.lineTo(t[0], n[0])  : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);
       else for (var r = Lu(t), i = Lu(n), o = 0, u = 1; u < e; ++o, ++u) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[u], n[u]);
  ...
  Iu.prototype = {
    ...
    insert: function (t, n) {
      ...
      for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; ) e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r)  : (t === e.R && (Bu(this, e), e = (t = e).U), e.C = !1, r.C = !0, Hu(this, r))  : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r)  : (t === e.L && (Hu(this, e), e = (t = e).U), e.C = !1, r.C = !0, Bu(this, r)),
      e = t.U;
      this._.C = !1
    },
    remove: function (t) {
      ...
      o = t.L,
      u = t.R;
      if (e = o ? u ? ju(u)  : o : u, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && u ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== u ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = u, u.U = e)  : (e.U = i, i = e, t = e.R))  : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1;
       else {
        do {
          if (t === this._) break;
          if (t === i.L) {
            if ((n = i.R).C && (n.C = !1, i.C = !0, Bu(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
              n.R && n.R.C || (n.L.C = !1, n.C = !0, Hu(this, n), n = i.R),
              n.C = i.C,
              i.C = n.R.C = !1,
              Bu(this, i),
              t = this._;
            ...
            n.L && n.L.C || (n.R.C = !1, n.C = !0, Bu(this, n), n = i.L),
            n.C = i.C,
            i.C = n.L.C = !1,
            Hu(this, i),
            t = this._;
  ...
  ca.prototype = {
    ...
    triangles: function () {
      ...
      return this.cells.forEach(function (e, r) {
        if (o = (i = e.halfedges).length) for (var i, o, u, a = e.site, c = - 1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o; ) u = f,
        f = (s = n[i[c]]).left === a ? s.right : s.left,
        u && f && r < u.index && r < f.index && ua(a, u, f) < 0 && t.push([a.data,
        u.data,
        f.data])
      }),
      t
  ...
  t.cross = function (t, e, r) {
    ...
    s = e.length,
    f = new Array(c * s);
    for (null == r && (r = n), i = u = 0; i < c; ++i) for (a = t[i], o = 0; o < s; ++o, ++u) f[u] = r(a, e[o]);
    return f
  },
  ...
  t.histogram = function () {
    function t(t) {
      ...
      for (var p = h.length; h[0] <= f; ) h.shift(),
      --p;
      for (; h[p - 1] > l; ) h.pop(),
      --p;
      var d,
    ...
    t.domain = function (n) {
      return arguments.length ? (e = 'function' == typeof n ? n : Ca([n[0],
      n[1]]), t)  : e
    },
  ...
  t.thresholdFreedmanDiaconis = function (t, n, e) {
    return t = Aa.call(t, Ma).sort(ya),
    Math.ceil((e - n) / (2 * (Oa(t, 0.75) - Oa(t, 0.25)) * Math.pow(t.length, - 1 / 3)))
  },
  t.thresholdScott = function (t, n, e) {
    return Math.ceil((e - n) / (3.5 * Na(t) * Math.pow(t.length, - 1 / 3)))
  },
  t.thresholdSturges = Ua,
  t.max = function (t, n) {
    var e,
    r,
    i = t.length,
  ...
  t.mean = function (t, n) {
    ...
    o = - 1,
    u = 0;
    if (null == n) for (; ++o < r; ) isNaN(e = Ma(t[o])) ? --i : u += e;
     else for (; ++o < r; ) isNaN(e = Ma(n(t[o], o, t))) ? --i : u += e;
    if (i) return u / i
  },
  t.median = function (t, n) {
    ...
    if (null == n) for (; ++i < r; ) isNaN(e = Ma(t[i])) || o.push(e);
     else for (; ++i < r; ) isNaN(e = Ma(n(t[i], i, t))) || o.push(e);
    return Oa(o.sort(ya), 0.5)
  },
  t.merge = Fa,
  t.min = Ia,
  ...
  t.ribbon = function () {
    function t() {
      ...
      g = i.apply(this, a) - jf,
      _ = o.apply(this, a) - jf;
      if (u || (u = t = Vt()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === g && h === _ || (u.quadraticCurveTo(0, 0, v * Yf(g), v * Bf(g)), u.arc(0, 0, v, g, _)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t) return u = null,
      t + '' || null
    }
    var n = $t,
    e = Wt,
  ...
  t.nest = function () {
    function t(n, i, u, a) {
      ...
      null != r ? r(n)  : n;
      for (var c, s, f, l = - 1, h = n.length, p = o[i++], d = Kt(), v = u(); ++l < h; ) (f = d.get(c = p(s = n[l]) + '')) ? f.push(s)  : d.set(c, [
        s
      ]);
  ...
  t.drag = function () {
    ...
    function i() {
      vc(t.event.view).on('mousemove.drag mouseup.drag', null),
      C(t.event.view, h),
      _c(),
      m.mouse('end')
    }
    ...
    function s(e, r, i, o, u) {
      ...
      if (d(new z(n, 'beforestart', a, e, b, f[0], f[1], 0, 0, l), function () {
        ...
        d(new z(n, h, a, e, p, f[0] + c, f[1] + s, f[0] - v[0], f[1] - v[1], l), l.apply, l, [
          h,
          o,
          u
        ])
  ...
  t.forceCollide = function (t) {
    function n() {
      for (var t, n, r, c, s, f, l, h = i.length, p = 0; p < a; ++p) for (n = sn(i, hn, pn).visitAfter(e), t = 0; t < h; ++t) r = i[t],
      f = o[r.index],
      l = f * f,
      c = r.x + r.vx,
      s = r.y + r.vy,
    ...
    u = 1,
    a = 1;
    return 'function' != typeof t && (t = vl(null == t ? 1 : + t)),
  ...
  t.forceLink = function (t) {
    function n(n) {
      for (var e = 0, r = t.length; e < p; ++e) for (var i, a, c, f, l, h, d, v = 0; v < r; ++v) a = (i = t[v]).source,
      f = (c = i.target).x + c.vx - a.x - a.vx || gl(),
      l = c.y + c.vy - a.y - a.vy || gl(),
    ...
    function e() {
      if (a) {
        ...
        'object' != typeof e.source && (e.source = vn(p, e.source)),
        'object' != typeof e.target && (e.target = vn(p, e.target)),
  ...
  t.forceManyBody = function () {
    ...
    function r(t, n, e, r) {
      ...
      h = r - n,
      p = i * i + c * c;
      if (h * h / l < p) return p < f && (0 === i && (i = gl(), p += i * i), 0 === c && (c = gl(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p),
      !0;
      if (!(t.length || p >= f)) {
  ...
  t.forceRadial = function (t, n, e) {
    ...
    a,
    c = vl(0.1);
    return 'function' != typeof t && (t = vl( + t)),
    null == n && (n = 0),
    null == e && (e = 0),
  ...
  t.forceSimulation = function (t) {
    ...
    function e() {
      ...
      for (u += (f - u) * s, h.each(function (t) {
        t(u)
      }), n = 0; n < r; ++n) null == (e = t[n]).fx ? e.x += e.vx *= l : (e.x = e.fx, e.vx = 0),
      null == e.fy ? e.y += e.vy *= l : (e.y = e.fy, e.vy = 0)
    }
    function r() {
  ...
  t.forceX = function (t) {
    ...
    o,
    u = vl(0.1);
    return 'function' != typeof t && (t = vl(null == t ? 0 : + t)),
    n.initialize = function (t) {
      r = t,
      e()
    },
  ...
  t.formatDefaultLocale = xn,
  t.formatLocale = Cl,
  t.formatSpecifier = yn,
  t.precisionFixed = zl,
  t.precisionPrefix = Pl,
  t.precisionRound = Rl,
  ...
  t.geoBounds = function (t) {
    ...
    u,
    a;
    if (Hl = Bl = - (Il = Yl = 1 / 0), Wl = [
    ], Lh(t, Fh), e = Wl.length) {
      for (Wl.sort(Zn), n = 1, o = [
        r = Wl[0]
      ]; n < e; ++n) Gn(r, (i = Wl[n]) [0]) || Gn(r, i[1]) ? (Wn(r[0], i[1]) > Wn(r[0], r[1]) && (r[1] = i[1]), Wn(i[0], r[1]) > Wn(r[0], r[1]) && (r[0] = i[0]))  : o.push(r = i);
      for (u = - 1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n) i = o[n],
      (a = Wn(r[1], i[0])) > u && (u = a, Il = i[0], Bl = r[1])
    }
    return Wl = Zl = null,
    Il === 1 / 0 || Yl === 1 / 0 ? [
      [NaN,
  ...
  t.geoCentroid = function (t) {
    Gl = Ql = Jl = Kl = th = nh = eh = rh = ih = oh = uh = 0,
    Lh(t, Ih);
    var n = ih,
    e = oh,
    r = uh,
    i = n * n + e * e + r * r;
    return i < 1e-12 && (n = nh, e = eh, r = rh, Ql < ph && (n = Jl, e = Kl, r = th), (i = n * n + e * e + r * r) < 1e-12) ? [
      NaN,
      NaN
    ] : [
      wh(e, n) * yh,
  ...
  t.geoCircle = function () {
    ...
    return t.center = function (n) {
      return arguments.length ? (r = 'function' == typeof n ? n : Yh([ + n[0],
      + n[1]]), t)  : r
    },
    t.radius = function (n) {
  ...
  t.geoPath = function (t, n) {
    function e(t) {
      return t && ('function' == typeof o && i.pointRadius( + o.apply(this, arguments)), Lh(t, r(i))),
      i.result()
    }
    var r,
    i,
  ...
  t.geoAlbersUsa = function () {
    ...
    return t.invert = function (t) {
      ...
      r = (t[0] - e[0]) / n,
      i = (t[1] - e[1]) / n;
      return (i >= 0.12 && i < 0.234 && r >= - 0.425 && r < - 0.214 ? s : i >= 0.166 && i < 0.234 && r >= - 0.214 && r < - 0.115 ? f : c).invert(t)
    },
    t.stream = function (t) {
    ...
    t.scale = function (n) {
      return arguments.length ? (c.scale(n), s.scale(0.35 * n), f.scale(n), t.translate(c.translate()))  : c.scale()
    },
    t.translate = function (t) {
      ...
      r = + t[0],
      a = + t[1];
      return i = c.translate(t).clipExtent([[r - 0.455 * e,
      a - 0.238 * e],
      [
        r + 0.455 * e,
        a + 0.238 * e
      ]]).stream(l),
      o = s.translate([r - 0.307 * e,
      a + 0.201 * e]).clipExtent([[r - 0.425 * e + ph,
      a + 0.12 * e + ph],
      [
        r - 0.214 * e - ph,
        a + 0.234 * e - ph
      ]]).stream(l),
      u = f.translate([r - 0.205 * e,
      a + 0.212 * e]).clipExtent([[r - 0.214 * e + ph,
      a + 0.166 * e + ph],
      [
        r - 0.115 * e - ph,
        a + 0.234 * e - ph
  ...
  t.geoAzimuthalEqualAreaRaw = Jp,
  t.geoAzimuthalEquidistant = function () {
    return er(Kp).scale(79.4188).clipAngle(179.999)
  },
  t.geoAzimuthalEquidistantRaw = Kp,
  t.geoConicConformal = function () {
    return ir(lr).scale(109.5).parallels([30,
    30])
  },
  t.geoConicConformalRaw = lr,
  t.geoConicEqualArea = Gp,
  t.geoConicEqualAreaRaw = or,
  t.geoConicEquidistant = function () {
    return ir(pr).scale(131.154).center([0,
    13.9389])
  },
  t.geoConicEquidistantRaw = pr,
  t.geoEquirectangular = function () {
    return er(hr).scale(152.63)
  },
  t.geoEquirectangularRaw = hr,
  ...
  t.geoIdentity = function () {
    ...
    return u = {
      ...
      translate: function (n) {
        return arguments.length ? (h = vr(a * f, a * l, c = + n[0], s = + n[1]), t())  : [
          c,
          s
        ]
      },
  ...
  t.pack = function () {
    function t(t) {
      return t.x = e / 2,
      t.y = r / 2,
      n ? t.eachBefore(Br(n)).eachAfter(Hr(i, 0.5)).eachBefore(jr(1))  : t.eachBefore(Br(Yr)).eachAfter(Hr(Ir, 1)).eachAfter(Hr(i, t.r / Math.min(e, r))).eachBefore(jr(Math.min(e, r) / (2 * t.r))),
      t
    }
    var n = null,
    e = 1,
  ...
  t.partition = function () {
    ...
    t.size = function (r) {
      return arguments.length ? (n = + r[0], e = + r[1], t)  : [
        n,
        e
      ]
    },
  ...
  t.stratify = function () {
    function t(t) {
      ...
      for (i = 0; i < f; ++i) r = t[i],
      a = l[i] = new Er(r),
      null != (c = n(r, i, t)) && (c += '') && (h[s = od + (a.id = c)] = s in h ? ad : a);
  ...
  t.tree = function () {
    function t(t) {
      var c = function (t) {
        for (var n, e, r, i, o, u = new Jr(t, 0), a = [
          u
        ]; n = a.pop(); ) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) a.push(e = n.children[i] = new Jr(r[i], i)),
        e.parent = n;
        return (u.parent = new Jr(null, 0)).children = [
          u
        ],
        u
      }(t);
    ...
    function n(t) {
      ...
      if (n) {
        (function (t) {
          for (var n, e = 0, r = 0, i = t.children, o = i.length; --o >= 0; ) (n = i[o]).z += e,
          n.m += e,
          e += n.s + (r += n.c)
        }) (t);
      ...
      t.parent.A = function (t, n, e) {
        if (n) {
          for (var r, o = t, u = t, a = n, c = o.parent.children[0], s = o.m, f = u.m, l = a.m, h = c.m; a = Zr(a), o = Wr(o), a && o; ) c = Wr(c),
          (u = Zr(u)).a = t,
          (r = a.z + l - o.z - s + i(a._, o._)) > 0 && (Gr(Qr(a, t, e), t, r), s += r, f += r),
          l += a.m,
          s += o.m,
          h += c.m,
          f += u.m;
          a && !Zr(u) && (u.t = a, u.m += l - f),
          o && !Wr(c) && (c.t = o, c.m += s - h, e = t)
        }
        return e
      }(t, r, t.parent.A || e[0])
    }
    ...
    t.size = function (n) {
      return arguments.length ? (a = !1, o = + n[0], u = + n[1], t)  : a ? null : [
        o,
        u
      ]
    },
    t.nodeSize = function (n) {
      return arguments.length ? (a = !0, o = + n[0], u = + n[1], t)  : a ? [
        o,
        u
      ] : null
    },
  ...
  t.treemapSquarify = fd,
  t.treemapResquarify = ld,
  t.interpolate = vs,
  t.interpolateArray = cs,
  t.interpolateBasis = es,
  t.interpolateBasisClosed = rs,
  t.interpolateDate = ss,
  t.interpolateNumber = fs,
  t.interpolateObject = ls,
  t.interpolateRound = gs,
  t.interpolateString = ds,
  t.interpolateTransformCss = xs,
  t.interpolateTransformSvg = bs,
  t.interpolateZoom = Ms,
  t.interpolateRgb = os,
  t.interpolateRgbBasis = us,
  t.interpolateRgbBasisClosed = as,
  t.interpolateHsl = Ts,
  t.interpolateHslLong = Ns,
  ...
  t.interpolateHcl = ks,
  t.interpolateHclLong = Ss,
  t.interpolateCubehelix = Es,
  t.interpolateCubehelixLong = As,
  ...
  t.polygonArea = function (t) {
    for (var n, e = - 1, r = t.length, i = t[r - 1], o = 0; ++e < r; ) n = i,
    i = t[e],
    o += n[1] * i[0] - n[0] * i[1];
    return o / 2
  },
  t.polygonCentroid = function (t) {
    for (var n, e, r = - 1, i = t.length, o = 0, u = 0, a = t[i - 1], c = 0; ++r < i; ) n = a,
    a = t[r],
    c += e = n[0] * a[1] - a[0] * n[1],
    o += (n[0] + a[0]) * e,
    u += (n[1] + a[1]) * e;
  ...
  t.polygonContains = function (t, n) {
    for (var e, r, i = t.length, o = t[i - 1], u = n[0], a = n[1], c = o[0], s = o[1], f = !1, l = 0; l < i; ++l) e = (o = t[l]) [0],
  ...
  t.polygonLength = function (t) {
    for (var n, e, r = - 1, i = t.length, o = t[i - 1], u = o[0], a = o[1], c = 0; ++r < i; ) n = u,
    e = a,
    n -= u = (o = t[r]) [0],
    e -= a = o[1],
    c += Math.sqrt(n * n + e * e);
  ...
  t.randomUniform = gd,
  t.randomNormal = _d,
  t.randomLogNormal = yd,
  t.randomBates = xd,
  t.randomIrwinHall = md,
  t.randomExponential = bd,
  t.request = wd,
  t.html = Td,
  t.json = Nd,
  t.text = kd,
  ...
  t.scaleSqrt = function () {
    return Mi().exponent(0.5)
  },
  t.scaleQuantile = Ti,
  t.scaleQuantize = Ni,
  t.scaleThreshold = ki,
  t.scaleTime = function () {
    return jo(gv, dv, tv, Jd, Gd, Wd, Vd, Bd, t.timeFormat).domain([new Date(2000, 0, 1),
    new Date(2000, 0, 2)])
  },
  t.scaleUtc = function () {
    return jo(Iv, Ov, Tv, wv, xv, yv, Vd, Bd, t.utcFormat).domain([Date.UTC(2000, 0, 1),
    Date.UTC(2000, 0, 2)])
  },
  t.schemeCategory10 = rg,
  t.schemeCategory20b = ig,
  t.schemeCategory20c = og,
  t.schemeCategory20 = ug,
  t.interpolateCubehelixDefault = ag,
  t.interpolateRainbow = function (t) {
    (t < 0 || t > 1) && (t -= Math.floor(t));
    var n = Math.abs(t - 0.5);
    return fg.h = 360 * t - 100,
    fg.s = 1.5 - 1.5 * n,
    fg.l = 0.8 - 0.9 * n,
    fg + ''
  },
  t.interpolateWarm = cg,
  t.interpolateCool = sg,
  t.interpolateViridis = lg,
  t.interpolateMagma = hg,
  t.interpolateInferno = pg,
  t.interpolatePlasma = dg,
  t.scaleSequential = Vo,
  t.creator = Ka,
  t.local = f,
  t.matcher = ic,
  t.mouse = cc,
  ...
  t.selectAll = function (t) {
    return 'string' == typeof t ? new S([document.querySelectorAll(t)], [
      document.documentElement
    ])  : new S([null == t ? [
    ] : t], dc)
  },
  ...
  t.arc = function () {
    function t() {
      ...
      d = gg(p - h),
      v = p > h;
      if (c || (c = t = Vt()), l < f && (s = l, l = f, f = s), l > Mg) if (d > kg - Mg) c.moveTo(l * yg(h), l * bg(h)),
      c.arc(0, 0, l, h, p, !v),
      f > Mg && (c.moveTo(f * yg(p), f * bg(p)), c.arc(0, 0, f, p, h, v));
       else {
        var g,
        _,
        y = h,
        ...
        if (N > Mg) {
          var A = $o(N / f * bg(T)),
          C = $o(N / l * bg(T));
          (w -= 2 * A) > Mg ? (A *= v ? 1 : - 1, x += A, b -= A)  : (w = 0, x = b = (h + p) / 2),
          (M -= 2 * C) > Mg ? (C *= v ? 1 : - 1, y += C, m -= C)  : (M = 0, y = m = (h + p) / 2)
        }
        var z = l * yg(y),
        P = l * bg(y),
        R = f * yg(b),
        ...
        M > Mg ? E > Mg ? (g = Ko(U, O, z, P, l, E, v), _ = Ko(q, D, R, L, l, E, v), c.moveTo(g.cx + g.x01, g.cy + g.y01), E < k ? c.arc(g.cx, g.cy, E, _g(g.y01, g.x01), _g(_.y01, _.x01), !v)  : (c.arc(g.cx, g.cy, E, _g(g.y01, g.x01), _g(g.y11, g.x11), !v), c.arc(0, 0, l, _g(g.cy + g.y11, g.cx + g.x11), _g(_.cy + _.y11, _.cx + _.x11), !v), c.arc(_.cx, _.cy, E, _g(_.y11, _.x11), _g(_.y01, _.x01), !v)))  : (c.moveTo(z, P), c.arc(0, 0, l, y, m, !v))  : c.moveTo(z, P),
        f > Mg && w > Mg ? S > Mg ? (g = Ko(R, L, q, D, f, - S, v), _ = Ko(z, P, U, O, f, - S, v), c.lineTo(g.cx + g.x01, g.cy + g.y01), S < k ? c.arc(g.cx, g.cy, S, _g(g.y01, g.x01), _g(_.y01, _.x01), !v)  : (c.arc(g.cx, g.cy, S, _g(g.y01, g.x01), _g(g.y11, g.x11), !v), c.arc(0, 0, f, _g(g.cy + g.y11, g.cx + g.x11), _g(_.cy + _.y11, _.cx + _.x11), v), c.arc(_.cx, _.cy, S, _g(_.y11, _.x11), _g(_.y01, _.x01), !v)))  : c.arc(0, 0, f, b, x, v)  : c.lineTo(R, L)
      } else c.moveTo(0, 0);
  ...
  t.symbol = function () {
    function t() {
      var t;
      if (r || (r = t = Vt()), n.apply(this, arguments).draw(r, + e.apply(this, arguments)), t) return r = null,
      t + '' || null
    }
    var n = vg(Ug),
    e = vg(64),
  ...
  t.curveBundle = e_,
  t.curveCardinalClosed = i_,
  t.curveCardinalOpen = o_,
  t.curveCardinal = r_,
  t.curveCatmullRomClosed = a_,
  t.curveCatmullRomOpen = c_,
  t.curveCatmullRom = u_,
  ...
  t.timeInterval = Si,
  t.timeMillisecond = Bd,
  t.timeMilliseconds = Hd,
  t.utcMillisecond = Bd,
  t.utcMilliseconds = Hd,
  t.timeSecond = Vd,
  t.timeSeconds = $d,
  t.utcSecond = Vd,
  t.utcSeconds = $d,
  ...
  t.utcYear = Iv,
  t.utcYears = Bv,
  t.timeFormatDefaultLocale = Yo,
  t.timeFormatLocale = Ri,
  t.isoFormat = $v,
  t.isoParse = Wv,
  t.now = gt,
  t.timer = mt,
  ...
  t.active = function (t, n) {
    ...
    if (i) {
      n = null == n ? null : n + '';
      for (r in i) if ((e = i[r]).state > Hs && e.name === n) return new Et([[t]], Nf, n, + r)
    }
    return null
  },
  t.interrupt = Gs,
  t.voronoi = function () {
    function t(t) {
      return new ca(t.map(function (r, i) {
        var o = [
          Math.round(n(r, i, t) / x_) * x_,
          Math.round(e(r, i, t) / x_) * x_
        ];
        return o.index = i,
        o.data = r,
        o
  ...
  t.zoom = function () {
    ...
    function s() {
      if (y.apply(this, arguments)) {
        ...
        t.zoom('mouse', x(r(e(n, i), t.mouse[0], t.mouse[1]), t.extent, T))
      }
    }
    function f() {
    ...
    function l() {
      if (y.apply(this, arguments)) {
        ...
        u = cc(this),
        a = i.invert(u),
        c = i.k * (t.event.shiftKey ? 0.5 : 2),
        s = x(r(e(i, c), u, a), m.apply(this, arguments), T);
        T_(),
        N > 0 ? vc(this).transition().duration(N).call(o, s, u)  : vc(this).call(n.transform, s)
      }
    }
    function h() {
      if (y.apply(this, arguments)) {
        ...
        c = a.length;
        for (la(), e = 0; e < c; ++e) r = a[e],
        i = [
          i = gc(this, a, r.identifier),
          this.__zoom.invert(i),
          r.identifier
        ],
        o.touch0 ? o.touch1 || (o.touch1 = i)  : (o.touch0 = i, n = !0);
        if (g && (g = clearTimeout(g), !o.touch1)) return o.end(),
        void ((i = vc(this).on('dblclick.zoom')) && i.apply(this, arguments));
    ...
    function p() {
      ...
      f = s.length;
      for (T_(), g && (g = clearTimeout(g)), n = 0; n < f; ++n) i = s[n],
      o = gc(this, s, i.identifier),
    ...
    c.prototype = {
      start: function () {
        return 1 == ++this.active && (this.index = S.push(this) - 1, this.emit('start')),
        this
      },
      zoom: function (t, n) {
        ...
        return 0 == --this.active && (S.splice(this.index, 1), this.index = - 1, this.emit('end')),
        this
      },
      emit: function (t) {
        d(new function (t, n, e) {
          ...
          this.type = n,
          this.transform = e
        }(n, t, this.that.__zoom), E.apply, E, [
          t,
          this.that,
          this.args
        ])
    ...
    n.extent = function (t) {
      return arguments.length ? (m = 'function' == typeof t ? t : w_([[ + t[0][0],
      + t[0][1]],
      [
        + t[1][0],
        + t[1][1]
    ...
    n.scaleExtent = function (t) {
      return arguments.length ? (M[0] = + t[0], M[1] = + t[1], n)  : [
        M[0],
        M[1]
      ]
    },
